...
bool interfaces__srv__find_path__response__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  ...
  {  // boxes
    ...
    rosidl_runtime_c__String__assign(&ros_message->boxes, PyBytes_AS_STRING(encoded_field));
    Py_DECREF(encoded_field);
    Py_DECREF(field);
  }
  {  // boxtimeline
    PyObject * field = PyObject_GetAttrString(_pymsg, "boxtimeline");
    if (!field) {
      return false;
    }
    assert(PyUnicode_Check(field));
    ...
    rosidl_runtime_c__String__assign(&ros_message->boxtimeline, PyBytes_AS_STRING(encoded_field));
    Py_DECREF(encoded_field);
    Py_DECREF(field);
  }
  {  // elapsedtime
...
PyObject * interfaces__srv__find_path__response__convert_to_py(void * raw_ros_message)
{
  ...
  {  // boxes
    PyObject * field = NULL;
    field = PyUnicode_DecodeUTF8(
      ros_message->boxes.data,
      strlen(ros_message->boxes.data),
      "replace");
    if (!field) {
      return NULL;
    }
  ...
  {  // boxtimeline
    PyObject * field = NULL;
    field = PyUnicode_DecodeUTF8(
      ros_message->boxtimeline.data,
      strlen(ros_message->boxtimeline.data),
      "replace");
    if (!field) {
      return NULL;
    }
    {
      int rc = PyObject_SetAttrString(_pymessage, "boxtimeline", field);
      Py_DECREF(field);
      if (rc) {
        return NULL;
      }
