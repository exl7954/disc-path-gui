...
class Metaclass_TestService(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            from interfaces.srv import _test_service
...
class TestService(metaclass=Metaclass_TestService):
    from interfaces.srv._test_service import TestService_Request as Request
    from interfaces.srv._test_service import TestService_Response as Response
